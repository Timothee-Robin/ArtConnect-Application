...
INSERT INTO Gallery (Gallery_ID, name, adress, ownerName, openingHours, contactPhone, rating, website) VALUES
...
INSERT INTO Community_Member (CommunityMember_ID, name, email, birthYear, phone, city, membershipType) VALUES
(1, 'Alex Johnson', 'alex.j@email.com', 1995, '1112223333', 'Paris', 'Premium'),
(2, 'Maria Garcia', 'maria.g@email.com', 1988, '4445556666', 'New York', 'Standard'),
(3, 'Liam O''Connor', 'liam.o@email.com', 2000, '7778889999', 'London', 'Student');
...
(3, 'Iron Forest', 2024, 'Original', 'Recycled Metal', '200x100x100cm', 'A tree made of car parts.', 3500.00, 'On Loan', 1, 3); -- Notice Sarah (Artist 3) is featured in Gallery 1's exhibition
...
(1, 1), -- Elena practices Painting
(2, 2), -- Marcus practices Photography
(2, 3), -- Marcus ALSO practices Digital Art (Multiple disciplines)
(3, 4); -- Sarah practices Sculpture
...
(1, 1, '2026-04-01 10:00:00', 'Paid'), -- Alex books Urban Sketching
(1, 2, '2026-04-02 11:30:00', 'Paid'), -- Alex ALSO books Photoshop (Cross-participation)
(2, 2, '2026-04-05 09:15:00', 'Pending'); -- Maria books Photoshop

-- 11. Insert Artwork Tags (Depends on Artwork, Artwork_Tag)
INSERT INTO Tag (Artwork_ID, ArtworkTag_ID) VALUES
(1, 1), -- Neon Nights is Abstract
(1, 2), -- Neon Nights is ALSO Cityscape (Multiple tags)
(2, 4), -- Data Stream is Cyberpunk
(3, 3); -- Iron Forest is Eco-Art

-- 12. Insert Favored Disciplines (Depends on Community_Member, Discipline)
INSERT INTO favored (CommunityMember_ID, Discipline_ID) VALUES
(1, 1), -- Alex favors Painting
(1, 3), -- Alex also favors Digital Art
(2, 3), -- Maria favors Digital Art
(3, 4); -- Liam favors Sculpture

-- Optional: Synchronize SERIAL sequences (Specific to PostgreSQL)
-- Because we hardcoded IDs (1, 2, 3), we need to tell Postgres to start auto-incrementing from the next highest number (4) for future inserts.
